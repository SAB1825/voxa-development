...
(function() {
  ...
  if (!organizationId) {
    console.error('Voxa Widget: data-organization-id attribute is required');
    return;
  }
  ...
  function render() {
    ...
    container.id = 'voxa-widget-container';
