...
export const CustomizationView = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-scree flex flex-col items-center justify-center gap-y-2 bg-muted p-8">
    ...
    <div className="flex min-h-screen flex-col bg-muted p-8">
      <div className="max-w-screen mx-auto w-full">
        <div className="space-y-2">
          ...
          <p>Customize how your chat widget looks and behaves for your customers</p>
        </div>
        <div className="mt-8">
